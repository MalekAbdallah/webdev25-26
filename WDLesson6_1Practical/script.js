...
let meat_prices = [5.55, 2.99, 1.99, 5.00];
let meat_titles = ["Beef Tips", "Brisket", "Ribeye", "Steak"];

let seafood_images = ["clams.jpg", "crabs.jpg,", "lobster.jpg", "shrimp.jpg", "tuna.jpg", "scallops.jpg"];
let seafood_prices = [5.99, 6.89, 8.99, 2.55, 5.99, 3.55];
let seafood_titles = ["Clams", "Crabs", "Lobster", "Shrimp", "Tuna", "Scallops"];

let dessert_images = ["flan.jpg", "oreo.jpg", "passionberry.jpg"];
let dessert_prices = [50.00, 28.99, 99.99];
let dessert_titles = ["Flan", "Oreo", "Passion Berry"];
